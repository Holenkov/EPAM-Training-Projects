...
import by.training.infohandling.parser.TextParser;
	...
	public class ParagraphParserTest {
		...
		public ParagraphParserTest(String sourceText, List<String> expected) {
			super();
		...
		public static List<Object[]> paramsForTest() throws NullResultException {
			List<Object[]> forTest = new ArrayList<>();
				...
				String parent = "paragraph";
				String child = "sentence";
		...
		public void parse(){
			...
			Parser parser = ParserInitializer.getParser(new ParagraphParcer());
